...
std::pair<util::Vec3, std::vector<int64_t>> Scene::calculate_radiance(
	...
	auto calc_rad = calculate_radiance(scatter_ray.value(), depth - 1);
...
std::pair<util::Vec3, int64_t> Scene::direct_lighting(const cam::Hit& h,
