...
namespace material {
	...
	DiffuseMaterial::DiffuseMaterial (const std::shared_ptr<util::Sampler>& albedo)
		: albedo_ (albedo), emission_ (std::make_shared<Constant> (Constant (util::Vec3 (0, 0, 0)))) {}
	DiffuseMaterial::DiffuseMaterial (const util::Vec3& color)
		: albedo_ (std::make_shared<Constant> (Constant (color))), emission_ (std::make_shared<Constant> (Constant (util::Vec3 (0, 0, 0)))) {}
